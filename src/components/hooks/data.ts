...
export const activities: Activity[] = [
    ...
    },
    {
        id:4,
        title:"GATHERING 2.0",
        description:"Dalam menjalani kehidupan perkuliahan, mahasiswa tidak hanya dituntut untuk mampu berdiri sendiri, tetapi juga untuk bisa bekerja sama dan saling membantu. Proses saling dukung ini sangat penting, terutama bagi mahasiswa baru yang masih berada dalam tahap pencarian ritme dan cara belajar yang sesuai. Melalui Gathering 2.0, mahasiswa baru FTI 2025 diberi kesempatan untuk membangun solidaritas sejak awal, sehingga terbentuk rasa kebersamaan yang kuat. Kebersamaan inilah yang nantinya akan menjadi fondasi bagi terciptanya lingkungan perkuliahan yang suportif, di mana setiap mahasiswa dapat berkembang dengan dukungan dari teman-temannya.",
        image:"/gath2fti25.png",
        imageAlt:"Gathering - Online gathering with FTI-students",
    },
    {
        id:5,
    ...
    {
        id:10,
        title:"AKSANG : SANGKARA",
        description:"AKSANG atau Aksi Angkatan adalah sebuah kegiatan yang dilakukan dengan kontribusi penuh satu angkatan FTI untuk menyalurkan ilmu maupun material ke masyarakat umum. Teruntuk angkatan 25 sendiri aksi angkatan mengambil tema SANGKARA : Berkarya dalam Ilmu, berdaya dalam aksi, dimana FTI'25 mengunjungi 2 SD dan 1 SMP untuk melakukan pembelajaran interaktif, diskusi, dan membuat gantungan kunci melalui kain perca limbah fast fashion. Selain itu, juga dilaksanakan pembagian paket sembako kepada 150 orang yang membutuhkan di jalanan Jatinangor.",
        image:"/aksangfti25.jpg",
        imageAlt:"aksang",
    },
    {
        id:11,
